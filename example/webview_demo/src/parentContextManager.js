 ...
 * On the Flutter side the counterpart is `FaroWebViewTracker` (see
 * `example/lib/features/webview_handoff/domain/faro_webview_tracker.dart`)
 * which creates the parent span and appends the `traceparent` to the URL.
 *
